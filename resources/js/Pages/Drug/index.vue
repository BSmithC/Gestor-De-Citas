        ...
        <template #default>
            <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6">
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg p-4 mb-6 border border-white/20 dark:border-gray-700/50">
                    ...
                    <div class="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 rounded-2xl shadow-lg overflow-hidden border border-white/20 dark:border-gray-700/50">
                ...
                <div v-if="infoModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm transition-opacity duration-300">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-white/20 dark:border-gray-700/50">
                        <!-- Modal Header -->
                        <div class="sticky top-0 z-10 bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-800 dark:to-indigo-800 px-6 py-4 rounded-t-2xl flex justify-between items-center">
                            <h2 class="text-xl font-bold text-white flex items-center gap-2">
                                ...
                                Medication Details: {{ selectedDrug.name }}
                            </h2>
                            <div class="flex space-x-2">
                                <Link :href="route('drugs.edit', selectedDrug.id)" 
                                        ...
                                        <dl class="space-y-4">
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <dd class="col-span-2 text-sm text-gray-900 dark:text-white font-medium">
                                                    {{ selectedDrug.name || 'Not available' }}
                                                </dd>
                                            </div>
                                            <div class="grid grid-cols-3 gap-4">
                                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Description</dt>
                                                <dd class="col-span-2 text-sm text-gray-900 dark:text-white font-medium">
                                                    {{ selectedDrug.description || 'Not available' }}
                                                </dd>
                                            </div>
                                        </dl>
                                    </div>
                                    ...
                                    <div class="p-4">
                                        <dl class="space-y-4">
                                            <div class="grid grid-cols-3 gap-4">
                                                ...
                                                <dd class="col-span-2 text-sm text-gray-900 dark:text-white font-medium">
                                                    {{ selectedDrug.route || 'Not specified' }}
                                                </dd>
                                            </div>
                                            <div class="grid grid-cols-3 gap-4">
                                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Frequency</dt>
                                                <dd class="col-span-2 text-sm text-gray-900 dark:text-white font-medium">
                                                    {{ selectedDrug.frequency || 'Not specified' }}
                                                </dd>
                                            </div>
                                            <div class="grid grid-cols-3 gap-4">
                                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Duration</dt>
                                                <dd class="col-span-2 text-sm text-gray-900 dark:text-white font-medium">
                                                    {{ selectedDrug.duration || 'Not specified' }}
                                                </dd>
                                            </div>
                                        </dl>
                                    </div>
...
export default {
    ...
    updateDrug () {
        router.post(route('drugs.update', this.selectedDrug.id), this.selectedDrug, {
            onSuccess: () => this.closeModal()
        });
    },
        storeDrug() {
            router.put(route('drugs.store', this.selectedDrug), this.selectedDrug, {});
        },
    },
    data() {
        return {
